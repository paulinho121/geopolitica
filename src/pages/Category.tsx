...
export default function Category() {
  ...
  return (
    <>
      <Helmet>
        <title>{category} | GlobalPulse News</title>
        <meta name="description" content={`Últimas notícias sobre ${category}. Cobertura completa e análises aprofundadas.`} />
      </Helmet>
        ...
        <div className="flex-grow">
          <div className="mb-8 pb-4 border-b-4 border-blue-600">
            ...
            <p className="text-gray-600 mt-2">
              Acompanhe as últimas atualizações e análises sobre {category.toLowerCase()}.
            </p>
          </div>
